...
public class AssembleScoreboardAdapter implements AssembleAdapter {

    private int inQueues;
    private int inFights;

    public AssembleScoreboardAdapter() {
        new BukkitRunnable() {
            @Override
            public void run() {
                int inQueues = 0;
                ...
                AssembleScoreboardAdapter.this.inQueues = inQueues;
                AssembleScoreboardAdapter.this.inFights = inFights;
            }
