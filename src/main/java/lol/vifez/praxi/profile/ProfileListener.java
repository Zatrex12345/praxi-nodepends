package lol.vifez.praxi.profile;

import lol.vifez.praxi.Praxi;
import lol.vifez.praxi.essentials.event.SpawnTeleportEvent;
import lol.vifez.praxi.profile.hotbar.Hotbar;
import lol.vifez.praxi.profile.hotbar.HotbarItem;
import lol.vifez.praxi.profile.meta.option.button.AllowSpectatorsOptionButton;
import lol.vifez.praxi.profile.meta.option.button.DuelRequestsOptionButton;
import lol.vifez.praxi.profile.meta.option.button.ShowScoreboardOptionButton;
import lol.vifez.praxi.profile.option.OptionsOpenedEvent;
import lol.vifez.praxi.profile.visibility.VisibilityLogic;
...
public class ProfileListener implements Listener {
	...
	public void onPlayerJoinEvent(PlayerJoinEvent event) {
		...
		new BukkitRunnable() {
			...
			public void run() {
				Hotbar.giveHotbarItems(event.getPlayer());
				Praxi.get().getEssentials().teleportToSpawn(event.getPlayer());
